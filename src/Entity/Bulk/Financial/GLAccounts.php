...
use PISystems\ExactOnline\Entity\Financial\DeductibilityPercentages;
 ...
 *
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=BulkFinancialGLAccounts
 * @see https://www.odata.org/documentation/odata-version-2-0/overview/#AbstractTypeSystem
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/bulk/Financial/GLAccounts", "Financial/GLAccounts")]
...
class GLAccounts extends DataSource
{
    ...
    /**
     * Deductibility percentages. You can have several Deductibility percentages, with start and end dates
     *
     *
     * @var ?array A collection of GLAccounts\DeductibilityPercentages
     */
    #[EDM\Collection(DeductibilityPercentages::class, 'DeductibilityPercentages')]
    #[Exact\Method(HttpMethod::GET)]
    public ?array $DeductibilityPercentages = null;
