 ...
 * Subscribe to the topic Quotations to get updates on the QuotationLines resource. Note that you will also receive events on the Quotations resource.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=CRMQuotationLines
 * @see https://www.odata.org/documentation/odata-version-2-0/overview/#AbstractTypeSystem
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/crm/QuotationLines", "QuotationLines")]
