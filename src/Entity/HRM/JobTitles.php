 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/hrm/JobTitles", "JobTitles")]
#[Exact\Method(HttpMethod::GET)]
class JobTitles extends DataSource
{
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $JobCode = null;

    /**
     * Group this job title belongs to
     *
     *
     * @var null|string Basic GUID type
     */
    #[EDM\Guid]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $JobGroup = null;
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $JobGroupCode = null;
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $JobGroupDescription = null;

    /**
     * Job title represents job level from
     *
     *
     * @var null|int Int32
     */
    #[EDM\Int32]
    #[Exact\Method(HttpMethod::GET)]
    public null|int $JobLevelFrom = null;

    /**
     * Job title represents job level to
     *
     *
     * @var null|int Int32
     */
    #[EDM\Int32]
    #[Exact\Method(HttpMethod::GET)]
    public null|int $JobLevelTo = null;
