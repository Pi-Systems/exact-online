...
/**
 * Use this endpoint to retrieve the digital postbox of an administration. If there is none assigned to this administration, it will grab the first digital postbox it encounters for the account.
 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/read/mailbox/DefaultMailbox", "DefaultMailbox")]
#[Exact\Method(HttpMethod::GET)]
class DefaultMailbox extends DataSource
{
