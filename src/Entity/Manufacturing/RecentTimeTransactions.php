 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/read/manufacturing/RecentTimeTransactions", "RecentTimeTransactions")]
#[Exact\Method(HttpMethod::GET)]
class RecentTimeTransactions extends DataSource
{
    ...
    /**
     * Hour Status of the time transaction: Rejected = 2, Submitted = 10, Approved = 20
     *
     *
     * @var null|int Int16
     */
    #[EDM\Int16]
    #[Exact\Method(HttpMethod::GET)]
    public null|int $HourStatus = null;
    ...
    #[EDM\Byte]
    #[Exact\Method(HttpMethod::GET)]
    public null|int $IsOperationFinished = null;

    /**
     * Shop order make item
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $LaborHours = null;
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $MachineHours = null;
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $PercentComplete = null;
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $ProducedQuantity = null;

    /**
     * Project ID of the shop order
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * Project code of the shop order
     *
     *
     * @var null|string
     */
    ...
    /**
     * Project description of the shop order
     *
     *
     * @var null|string
     */
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $ShopOrderPlannedQuantity = null;
    ...
    /**
     * Percentage of time attended on the routing step plan
     *
     *
     * @var null|float Double
     */
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $ShopOrderRoutingStepPlanAttendedPercentage = null;

    /**
     * Description of the shop order routing step where work occurred
     *
     *
     * @var null|string
     */
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $ShopOrderRoutingStepPlanDescription = null;
    ...
    /**
     * Status of the time transaction
     *
     *
     * @var null|int Int16
     */
    ...
    /**
     * Type of the time transaction: Setup = 10, Run = 20
     *
     *
     * @var null|int Int16
     */
