 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/manufacturing/TimedTimeTransactions", "TimedTimeTransactions")]
#[Exact\Method(HttpMethod::GET)]
#[Exact\Method(HttpMethod::POST)]
#[Exact\Method(HttpMethod::PUT)]
#[Exact\Method(HttpMethod::DELETE)]
class TimedTimeTransactions extends DataSource
{
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|string $ProductionArea = null;

    /**
     * Code of production area of the work center
     *
     *
     * @var null|string
     */
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|string $ProductionAreaCode = null;

    /**
     * Description of production area of the work center
     *
     *
     * @var null|string
     */
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|string $ProductionAreaDescription = null;
    ...
    /**
     * Description of the routing step plan
     *
     *
     * @var null|string
     */
    ...
    /**
     * Remaining planned run hours of the routing step plan
     *
     *
     * @var null|float Double
     */
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|float $ShopOrderRoutingStepPlanRemainingRunHours = null;

    /**
     * Remaining planned setup hours of the routing step plan
     *
     *
     * @var null|float Double
     */
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|float $ShopOrderRoutingStepPlanRemainingSetupHours = null;

    /**
     * Source of the timed time transaction
     *
     *
     * @var null|int Int32
     */
    ...
    /**
     * Type of the timed time transaction: Setup = 10, Run = 20
     *
     *
     * @var null|int Int32
     */
