 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/payroll/EmploymentOrganizations", "EmploymentOrganizations")]
...
class EmploymentOrganizations extends DataSource
{
    ...
    /**
     * Organization end dateNote : This property only supported for successor
     *
     *
     * @var null|\DateTimeInterface
     */
    ...
    /**
     * Organization start dateNote : This property only supported for successor
     *
     *
     * @var null|\DateTimeInterface
     */
