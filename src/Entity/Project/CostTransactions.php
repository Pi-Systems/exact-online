 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/project/CostTransactions", "CostTransactions")]
#[Exact\Method(HttpMethod::GET)]
#[Exact\Method(HttpMethod::POST)]
#[Exact\Method(HttpMethod::PUT)]
#[Exact\Method(HttpMethod::DELETE)]
class CostTransactions extends DataSource
{
    ...
    /**
     * Date and time the cost transaction was done
     *
     *
     * @var null|\DateTimeInterface
     */
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $DivisionDescription = null;

    /**
     * Guid ID of the employee that is linked to the cost transaction
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * Number that represents the grouping of cost transactions
     *
     *
     * @var null|int Int32
     */
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|string $ErrorText = null;

    /**
     * ProjectWBS (work breakdown structure) type 3
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * Description of ProjectWBS Expense
     *
     *
     * @var null|string
     */
    ...
    /**
     * Item that is linked to the transaction, which provides the cost information
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * The ID of the user that modified the records
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|float $PriceFC = null;

    /**
     * Project that is linked to the transaction
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    #[EDM\Guid]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $ProjectAccount = null;
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $ProjectAccountCode = null;
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $ProjectAccountName = null;
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|bool $SkipValidation = null;

    /**
     * Subscription that is linked to the transaction
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * Subscription account that is linked to the transaction, this is to identify the referenced subscription
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public null|string $SubscriptionAccount = null;
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $SubscriptionAccountCode = null;
    ...
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $SubscriptionAccountName = null;
    ...
    /**
     * The type of transaction. E.g: Time = 1, Cost = 2
     *
     *
     * @var null|int Int16
     */
