 ...
 * Note: Purchase entries are separated to header and line information. Endpoint PurchaseEntries is used for the header information. You must include a parameter for 'PurchaseEntryLines' to add purchase entry lines when you POST to the PurchaseEntries endpoint. This parameter is not necessary when you PUT to this endpoint.
 ...
 * Subscribe to the topic PurchaseEntries for updates on the PurchaseEntries resource. Note that you will also receive events on the PurchaseEntryLines resource.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=PurchaseEntryPurchaseEntries
 * @see https://www.odata.org/documentation/odata-version-2-0/overview/#AbstractTypeSystem
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/purchaseentry/PurchaseEntries", "PurchaseEntries")]
#[Exact\Method(HttpMethod::GET)]
#[Exact\Method(HttpMethod::POST)]
#[Exact\Method(HttpMethod::PUT)]
#[Exact\Method(HttpMethod::DELETE)]
class PurchaseEntries extends DataSource
{
     ...
     *
     *
     * @var ?array A collection of PurchaseEntries\PurchaseEntryLines
     */
    #[EDM\Collection(PurchaseEntryLines::class, 'PurchaseEntryLines')]
    #[Exact\Required]
    #[Exact\Method(HttpMethod::GET)]
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public ?array $PurchaseEntryLines = null;
