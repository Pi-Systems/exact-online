 ...
 *
 * When using the POST method of this endpoint to create a purchase order, it is mandatory to provide a valid supplier and purchase order lines. The purchase order lines is not necessary when you PUT to this endpoint.
 *
 * For more information about the  functionality in Exact Online, see Overview | Purchase orders.
 *
 * This entity supports webhooks.
 * Subscribe to the topic PurchaseOrders for updates on the PurchaseOrders resource. Note that you will also receive events on the PurchaseOrderLines resource.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=PurchaseOrderPurchaseOrders
 * @see https://www.odata.org/documentation/odata-version-2-0/overview/#AbstractTypeSystem
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/purchaseorder/PurchaseOrders", "PurchaseOrders")]
...
class PurchaseOrders extends DataSource
{
    ...
    /**
     * Approval status of purchase order. 0=Awaiting approval, 1=Automatically, 2=Approved.
     *
     *
     * @var null|int Int16
     */
    ...
    #[EDM\Int32]
    #[Exact\Method(HttpMethod::GET)]
    public null|int $PurchaseOrderLineCount = null;

    /**
     * Collection of lines
     *
     *
     * @var ?array A collection of PurchaseOrders\PurchaseOrderLines
     */
    #[EDM\Collection(PurchaseOrderLines::class, 'PurchaseOrderLines')]
    #[Exact\Required]
    #[Exact\Method(HttpMethod::GET)]
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    ...
    /**
     * Number of the sales order. Show NULL if more than one sales order is linked to the purchase order.
     *
     *
     * @var null|int Int32
     */
