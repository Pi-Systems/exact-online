 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/salesinvoice/SalesInvoices", "SalesInvoices")]
...
class SalesInvoices extends DataSource
{
     ...
     */
    #[EDM\Collection(SalesInvoiceLines::class, 'SalesInvoiceLines')]
    #[Exact\Required]
    #[Exact\Method(HttpMethod::GET)]
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    ...
    /**
     * Collection of shipping cost and order charge lines. Only applicable in POST. Ignore the URL returns in GET.
     *
     *
     * @var ?array A collection of SalesInvoices\SalesInvoiceOrderChargeLines
     */
    #[EDM\Collection(SalesInvoiceOrderChargeLines::class, 'SalesInvoiceOrderChargeLines')]
    #[Exact\Method(HttpMethod::GET)]
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public ?array $SalesInvoiceOrderChargeLines = null;
