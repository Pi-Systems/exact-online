 ...
 *   Create new drop shipments.
 *   Read existing drop shipments.
 *   Update existing drop shipments.
 *
 * Delivery lines support trade-in lines. For more details, please refer description under properties DropShipmentLines &gt; QuantityDelivered
 *
 * Note: For creating a DropShipments, it is mandatory to supply one or more DropShipmentLines and DeliveryDate.
 *
 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/salesorder/DropShipments", "DropShipments")]
#[Exact\Method(HttpMethod::GET)]
#[Exact\Method(HttpMethod::POST)]
#[Exact\Method(HttpMethod::PUT)]
class DropShipments extends DataSource
{
     ...
     *
     *
     * @var ?array A collection of DropShipments\DropShipmentLines
     */
    #[EDM\Collection(DropShipmentLines::class, 'DropShipmentLines')]
    #[Exact\Required]
    #[Exact\Method(HttpMethod::GET)]
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
    public ?array $DropShipmentLines = null;
