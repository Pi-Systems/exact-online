 ...
 *   Create new goods deliveries.
 *   Read existing goods deliveries.
 *   Update existing goods deliveries.
 *
 * Delivery lines support trade-in lines. For more details, please refer description under properties GoodsDeliveryLines &gt; QuantityDelivered
 *
 * Note: For creating a GoodsDeliveries, it is mandatory to supply one or more GoodsDeliveryLines and DeliveryDate.
 * Business example API goods delivery
 *
 * For more information about the  functionality in Exact Online, see Goods delivery - New.
 *
 * This entity supports webhooks.
 * Subscribe to the topic GoodsDeliveries to get updates on the GoodsDeliveries resource. Note that you will also receive events on the GoodsDeliveryLines resource.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SalesOrderGoodsDeliveries
 * @see https://www.odata.org/documentation/odata-version-2-0/overview/#AbstractTypeSystem
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/salesorder/GoodsDeliveries", "GoodsDeliveries")]
...
class GoodsDeliveries extends DataSource
{
     ...
     */
    #[EDM\Collection(GoodsDeliveryLines::class, 'GoodsDeliveryLines')]
    #[Exact\Required]
    #[Exact\Method(HttpMethod::GET)]
    #[Exact\Method(HttpMethod::POST)]
    #[Exact\Method(HttpMethod::PUT)]
