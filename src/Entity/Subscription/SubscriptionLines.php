 ...
 * Subscribe to the topic Subscriptions to get updates on the SubscriptionLines resource. Note that you will also receive events on the SubscriptionLines resource.
 *
 * @see https://start.exactonline.nl/docs/HlpRestAPIResourcesDetails.aspx?name=SubscriptionSubscriptionLines
 * @see https://www.odata.org/documentation/odata-version-2-0/overview/#AbstractTypeSystem
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/subscription/SubscriptionLines", "SubscriptionLines")]
