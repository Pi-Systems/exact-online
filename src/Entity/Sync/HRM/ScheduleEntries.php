 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/sync/HRM/ScheduleEntries", "HRM/ScheduleEntries")]
#[Exact\Method(HttpMethod::GET)]
class ScheduleEntries extends DataSource
{
    ...
    /**
     * This property is for Schedule type 4 (Time frames per day). Set to true if there is break time else false.
     *
     *
     * @var null|bool
     */
    #[EDM\Boolean]
    #[Exact\Method(HttpMethod::GET)]
    public null|bool $Break = null;

    /**
     * This is the break end time. This property is for Schedule type 4 (Time frames per day)
     *
     *
     * @var null|string
     */
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $BreakEndTime = null;

    /**
     * This is the break start time. This property is for Schedule type 4 (Time frames per day)
     *
     *
     * @var null|string
     */
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $BreakStartTime = null;
    ...
    /**
     * The day in the week. 0 - Monday; 1 - Tuesday; 2 - Wednesday; 3 - Thursday; 4 - Friday; 5 - Saturday; 6 - Sunday
     *
     *
     * @var null|int Int32
     */
    ...
    #[Exact\Required]
    #[Exact\Method(HttpMethod::GET)]
    public null|int $Day = null;

    /**
     * This property is required for Schedule type 2 (Hours and specific days).
     *
     *
     * @var null|bool
     */
    #[EDM\Boolean]
    #[Exact\Method(HttpMethod::GET)]
    public null|bool $DayIsSelected = null;
    ...
    /**
     * This is the end time of the work day. This property is for Schedule type 4 (Time frames per day)
     *
     *
     * @var null|string
     */
    ...
    /**
     * Set the total number of hours for per day. This property is for Schedule type 3 (Hours per day). Values should be in 'HH:mm' format, eg : 08:00
     *
     *
     * @var null|string
     */
    ...
    /**
     * The id of the schedule linked to this schedule entry.
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    #[EDM\Int32]
    #[Exact\Method(HttpMethod::GET)]
    public null|int $ScheduleActivityType = null;

    /**
     * This is the schedule type id based on the Schedule. 1 - Hours and average days; 2 - Hours and specific days; 3 - Hours per day; 4 - Time frames per day
     *
     *
     * @var null|int Int32
     */
    ...
    /**
     * This is the start time of the work day. This property is for Schedule type 4 (Time frames per day)
     *
     *
     * @var null|string
     */
