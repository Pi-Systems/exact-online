 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/sync/Inventory/StockPositions", "Inventory/StockPositions")]
#[Exact\Method(HttpMethod::GET)]
class StockPositions extends DataSource
{
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $FreeStock = null;
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $PlanningIn = null;
    ...
    #[EDM\Double]
    #[Exact\Method(HttpMethod::GET)]
    public null|float $PlanningOut = null;
    ...
    /**
     * Stock stored in the warehouse that is already reserved
     *
     *
     * @var null|float Double
     */
    ...
    /**
     * A guid that is the unique identifier of the warehouse
     *
     *
     * @var null|string Basic GUID type
     */
