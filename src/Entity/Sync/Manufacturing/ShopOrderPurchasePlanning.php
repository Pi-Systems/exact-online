...
/**
 * Any change in the ShopOrderPurchasePlanning will lead to a new timestamp value. The API will return the data in the same API call.
 *
 *
 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/sync/Manufacturing/ShopOrderPurchasePlanning", "Manufacturing/ShopOrderPurchasePlanning")]
#[Exact\Method(HttpMethod::GET)]
class ShopOrderPurchasePlanning extends DataSource
{
    ...
    /**
     * Reference to PurchaseOrderLines
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * Reference to ShopOrderMaterialPlans
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * Unique number to indentify the shop order
     *
     *
     * @var null|int Int32
     */
    ...
    /**
     * Reference to ShopOrderRoutingStepPlans
     *
     *
     * @var null|string Basic GUID type
     */
