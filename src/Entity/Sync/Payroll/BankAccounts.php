 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/sync/Payroll/BankAccounts", "Payroll/BankAccounts")]
#[Exact\Method(HttpMethod::GET)]
class BankAccounts extends DataSource
{
    ...
    /**
     * The bank account holder name. (maximum of 50 characters)
     *
     *
     * @var null|string
     */
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $BankAccountHolderName = null;

    /**
     * BIC code of the bank where the bank account is held. (maximum of 11 characters)
     *
     *
     * @var null|string
     */
    ...
    /**
     * The description of the bank account. (maximum of 60 characters)
     *
     *
     * @var null|string
     */
    ...
    /**
     * This is the employee id to which the bank account belongs to.
     *
     *
     * @var null|string Basic GUID type
     */
    ...
    /**
     * This indicates if the bank account is the main bank account
     *
     *
     * @var null|bool
     */
    ...
    /**
     * This is the bank account number. (maximum of 34 characters)
     *
     *
     * @var null|string
     */
