 ...
 */
#[Exact\PageSize(60)]
#[Exact\Endpoint("/api/v1/{division}/sync/Payroll/EmploymentCLAs", "Payroll/EmploymentCLAs")]
#[Exact\Method(HttpMethod::GET)]
class EmploymentCLAs extends DataSource
{
    ...
    /**
     * Employment conditions group ID
     *
     *
     * @var null|string Basic GUID type
     */
    #[EDM\Guid]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $PayrollComponentGroup = null;

    /**
     * Employment conditions group description
     *
     *
     * @var null|string
     */
    #[EDM\UTF8String]
    #[Exact\Method(HttpMethod::GET)]
    public null|string $PayrollComponentGroupDescription = null;

    /**
     * Employment CLA start date. By default the value of this property will be the first day of next month of     * previous Employment CLA start date
     *
     *
     * @var null|\DateTimeInterface
     */
