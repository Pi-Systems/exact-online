 ...
 */
abstract class SimpleAbstractLogger implements LoggerInterface
{
    /**
    ...
    protected static  function formatSimpleMessage($level, \Stringable|string $message, array $context = []) : array
    {
        ...
        if (is_string($level)) {
            try {
                ...
                $message = self::formatSimpleMessage(self::INFO, "Unknown log level used, defaulting message into the info channel.");
                $level = self::INFO;
            }
        } else {
